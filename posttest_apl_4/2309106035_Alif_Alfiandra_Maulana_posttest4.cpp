...
void UpdateChart() {
    ...
    if (nomor >= 1 && nomor <= peringkatchart) {
        ...
        while (!(cin >> chart[nomor - 1].peringkat)) {
            cin.clear();
            while (cin.get() != '\n');
            cout << "Masukkan peringkat dalam bentuk angka." << endl;
            cout << "Masukkan peringkat baru: ";
        ...
        getline(cin, chart[nomor - 1].infoAlbum.namaAlbum);
        cout << "Masukkan nama artis album baru: ";
        getline(cin, chart[nomor - 1].infoAlbum.artist);
        cout << "Masukkan tahun rilis album baru: ";
        while (!(cin >> chart[nomor - 1].infoAlbum.tahun)) {
            cin.clear();
            while (cin.get() != '\n');
